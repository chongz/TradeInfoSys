...
//            ImageView portrait_view = (ImageView) view.findViewById(R.id.person_info_image_view);
//            Glide.with(getContext()).load(Constant.ServicePicAddress + infoData.getValue()).placeholder(R.drawable.span).into(portrait_view);
//            return view;
//        }
