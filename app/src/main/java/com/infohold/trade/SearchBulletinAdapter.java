...
public class SearchBulletinAdapter extends ArrayAdapter<Bulletin> {
    private int resourceId;

    public SearchBulletinAdapter(Context context, int resource, List<Bulletin> objects) {
        ...
        viewHolder.btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (!((SearchBulletinActivity)getContext()).shouldShowRequestPermissionRationale(android.Manifest.permission.CAMERA)) {

                    }
                    ((SearchBulletinActivity)getContext()).requestPermissions(new String[]{android.Manifest.permission.CAMERA},Constant.REQUEST_CODE_ASK_PERMISSIONS_FROM_ADAPTER);
                }
